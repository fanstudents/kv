...
export const DATABASE_SURFACES: DatabaseSurface[] = [
  ...
  { table: "agent_goals", owner: "kv-primary", coverage: "defined" },
  ...
  { table: "ai_usage_logs", owner: "kv-primary", coverage: "defined" },
  { table: "broadcast_logs", owner: "kv-primary", coverage: "defined" },
  { table: "checklist_status", owner: "kv-primary", coverage: "defined" },
  { table: "contact_profiles", owner: "kv-primary", coverage: "defined" },
  { table: "contacts", owner: "kv-primary", coverage: "defined" },
  { table: "kb_chunks", owner: "kv-primary", coverage: "defined" },
  { table: "kb_citations", owner: "kv-primary", coverage: "defined" },
  { table: "kb_sources", owner: "kv-primary", coverage: "defined" },
  { table: "knowledge_access", owner: "kv-primary", coverage: "defined" },
  { table: "knowledge_base", owner: "kv-primary", coverage: "defined" },
  { table: "line_agent_activity", owner: "kv-primary", coverage: "defined" },
  { table: "line_agents", owner: "kv-primary", coverage: "defined" },
  { table: "line_conversation_locks", owner: "kv-primary", coverage: "defined" },
  { table: "line_subscribers", owner: "kv-primary", coverage: "defined" },
  { table: "line_support_conversations", owner: "kv-primary", coverage: "defined" },
